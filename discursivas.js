...
window.CT_DISCURSIVAS = [
 ...
 },
 {
  ...
  "tema": "Medidas de segurança: sistemas duplo binário e vicariante, pressupostos, duração, detração",
  "enunciado": "DISSERTAÇÃO\n\nDisserte sobre o tema \"Das Medidas de Segurança\".\n\nNo desenvolvimento da dissertação, discorra sobre os itens a seguir, de acordo com a ordem proposta.\n\n1. Sistemas de aplicação da pena e da medida de segurança. Sistemas duplo binário e vicariante. Natureza jurídica da medida de segurança.\n2. Pressupostos para aplicação da medida de segurança.\n3. Compatibilidade de duração indeterminada da medida de segurança e os princípios da isonomia e proporcionalidade.\n4. Efeitos da cessação da periculosidade. Avaliação da possibilidade da conversão da medida de segurança em pena.\n5. Detração e medida de segurança. Compatibilidade com o período mínimo de duração das medidas de segurança e a cessação da periculosidade.\n6. Pena de multa e medida de segurança",
  "espelho": [
   {
    "quesito": "1. Sistemas de aplicação de pena e da medida de segurança. Sistemas duplo binário e vicariante. Natureza jurídica da medida de segurança.",
    "pontos": 1
   },
   {
    "quesito": "2. Pressupostos para aplicação da medida de segurança.",
    "pontos": 1
   },
   {
    "quesito": "3. Compatibilidade de duração indeterminada da medida de segurança e os princípios da isonomia e proporcionalidade.",
    "pontos": 0.5
   },
   {
    "quesito": "4. Efeitos da cessação da periculosidade. Avaliação da possibilidade da conversão da medida de segurança em pena.",
    "pontos": 0.5
   },
   {
    "quesito": "5. Detração e medida de segurança. Compatibilidade com o período mínimo de duração das medidas de segurança e a cessação da periculosidade.",
    "pontos": 0.5
   },
   {
    "quesito": "6. Pena de multa e medida de segurança.",
    "pontos": 0.5
   }
  ],
  "total": 4,
  "fonte": "https://www.tjsp.jus.br/Segmento/Magistrados/Noticia?codigoNoticia=114081&pagina=1",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "tema": "Contratos de duração e complexidade: contratos relacionais, incompletos, contratos-quadro e redes contratuais",
  "enunciado": "QUESTÃO 1\n\nQuando se afirma que, em determinadas situações, \"o tempo está na causa do contrato\" e que, não raro, isso se associa a uma especial ou acentuada complexidade da relação contratual:\n\na) o que se quer assim significar, em termos conceituais?\nb) a que espécies ou (novos) tipos característicos de contratos se está a aludir?\nc) em que a questão interfere nas consequências operativas, acaso específicas ou recompreendidas, da disciplina geral dos contratos, nesses mesmos casos, seja do ponto de vista da dinâmica da relação entre os contratantes ou, ainda, da perspectiva das hipóteses de dissolução do ajuste?",
  "espelho": [
   {
    "quesito": "item (a): abordagem conceitual dos contratos de duração (execução diferida, continuada ou de trato sucessivo) associada à nota distintiva básica de acentuada complexidade da relação contratual, tendendo à identificação de novos tipos contratuais",
    "pontos": 0.5
   },
   {
    "quesito": "item (b): menção e caracterização dos contratos relacionais (incluindo cativos e de longa duração), contratos incompletos, contratos-quadro e, quanto à ligação com outros contratos, das redes contratuais, diferenciadas da coligação contratual",
    "pontos": 0.5
   },
   {
    "quesito": "item (c): consequências da identificação tipológica — exigência \"mais forte\" de boa-fé objetiva, dever geral de renegociação, recompreensão de \"terceiro\"; e, na dissolução, resolução e resilição (prazo moral, art. 473, parágrafo único, do CC)",
    "pontos": 0.5
   }
  ],
  "total": 1.5,
 ...
 },
 {
  ...
  "tema": "Princípio da capacidade contributiva, vedação ao confisco e mínimo vital",
  ...
  "espelho": [
   {
    "quesito": "1. Conceito de capacidade contributiva como critério de concretização da igualdade; evolução constitucional (Constituição de 1824, 1946, EC 18/1965, reintrodução no art. 145, § 1º, da CF/88)",
    "pontos": 0.4
   },
   {
    "quesito": "2. Aplicabilidade aos impostos (art. 145, § 1º); posição doutrinária majoritária que afasta a aplicação direta às taxas e à contribuição de melhoria; aplicabilidade indireta reconhecida pelo STF",
    "pontos": 0.4
   },
   {
    "quesito": "3. Vedação ao tributo com efeito de confisco como conceito juridicamente indeterminado; ausência de parâmetros objetivos, análise caso a caso pela proporcionalidade e razoabilidade; extensão às multas tributárias pelo STF",
    "pontos": 0.4
   },
   {
    "quesito": "4. Preservação do mínimo vital ou mínimo existencial como limite inferior ao poder de tributar, decorrente do próprio princípio da capacidade contributiva",
    "pontos": 0.3
   }
  ],
  "total": 1.5,
 ...
 },
 {
  ...
  "tema": "Medida socioeducativa de internação e doutrina da proteção integral",
  "enunciado": "QUESTÃO 3\n\nDisserte sobre o tema \"medida socioeducativa de internação à luz da doutrina da proteção integral\", abordando os seguintes pontos, não se limitando aos textos legais:\n\na) conteúdo da doutrina da proteção integral e sua aplicação ao adolescente autor de ato infracional;\nb) conceito e finalidades da medida socioeducativa de internação;\nc) espécies de internação e requisitos de cada uma;\nd) substituição da internação.",
  "espelho": [
   {
    "quesito": "Conteúdo da doutrina da proteção integral e sua aplicação ao adolescente autor de ato infracional (CF/88, criança e adolescente como sujeitos de direitos, prioridade absoluta, brevidade, excepcionalidade e respeito à condição peculiar de pessoa em desenvolvimento)",
    "pontos": 0.6
   },
   {
    "quesito": "Conceito e finalidade da medida socioeducativa de internação (restrição total de liberdade; finalidade pedagógica e ressocializadora, além da defesa da ordem pública)",
    "pontos": 0.2
   },
   {
    "quesito": "Espécies de internação e seus requisitos: provisória (art. 108, parágrafo único), sem prazo determinado (art. 122, I e II) e internação-sanção (art. 122, III), com a jurisprudência do STJ sobre gravidade abstrata e reiteração",
    "pontos": 0.6
   },
   {
    "quesito": "Substituição da internação a qualquer tempo por medida adequada e suficiente; reavaliação obrigatória no máximo a cada 6 meses",
    "pontos": 0.1
   }
  ],
  "total": 1.5,
 ...
 },
 {
  ...
  "cargo": "Juiz Substituto",
  "ano": 2025,
  "fase": "2a fase - prova escrita discursiva",
  "disciplina": "Direito Penal",
  "tema": "Culpabilidade: inexigibilidade de conduta diversa (legal e supralegal)",
  "enunciado": "Questão 1 – Direito Penal\n\nTendo por base a teoria do delito e, especialmente, o tema da culpabilidade em direito penal, responda as perguntas a seguir de forma objetivamente fundamentada e de acordo com aspectos teóricos e jurisprudenciais na matéria.\n\na) Em que consiste a inexigibilidade de conduta diversa, como ela se relaciona à evolução dogmática do conceito de culpabilidade e qual a consequência de seu eventual reconhecimento em um caso concreto?\n\nb) Quais são as hipóteses legais de inexigibilidade de conduta diversa? Explique cada uma delas.\n\nc) Admitem-se hipóteses supralegais de inexigibilidade de conduta diversa? Explique e, em caso positivo, exemplifique.\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "a1) Inserção da exigibilidade de comportamento diverso como elemento da concepção normativa de culpabilidade como reprovabilidade.",
    "pontos": 0.5
   },
   {
    "quesito": "a2) Conceito de exigibilidade de comportamento diverso como \"poder agir de outro modo\" condicionado à normalidade das circunstâncias da ação, levando a inexigibilidade à exculpação, ou seja, ao afastamento da culpabilidade no caso concreto, com a consequente absolvição.",
    "pontos": 0.5
   },
   {
    "quesito": "b1) Conceito e explicação correta quanto à coação moral irresistível (art. 22, CP) e seus requisitos, primeira hipótese legal de inexigibilidade de conduta diversa.",
    "pontos": 0.25
   },
   {
    "quesito": "b2) Conceito e explicação correta quanto à obediência hierárquica (art. 22, CP) e seus requisitos, segunda hipótese legal de inexigibilidade de conduta diversa.",
    "pontos": 0.25
   },
   {
    "quesito": "c) Sim, admite-se hipóteses supralegais de inexigibilidade de conduta diversa. Para pontuação total no item, deve ser dado ao menos um exemplo correto de sua aplicação, a partir da jurisprudência ou da doutrina.",
    "pontos": 0.5
   }
  ],
  "total": 2,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/tjmt-prova-discursiva.pdf"
 },
 {
  "id": "tj-mt-2025-2",
  "tipo": "discursiva",
  ...
  "fase": "2a fase - prova escrita discursiva",
  "disciplina": "Direito Administrativo",
  "tema": "Concurso público: reserva de vagas por gênero na carreira militar e posse de condenado criminalmente",
  ...
  "espelho": [
   {
    "quesito": "a1) As legislações que restringem a ampla participação de candidatas do gênero feminino, sem previsão legal e legitimamente justificadas, caracterizam afronta à igualdade de gênero, por restringirem a ampla participação de candidatas do sexo feminino em concursos públicos e afrontam o princípio da igualdade (CF, Art. 5º).",
    "pontos": 0.2
   },
   {
    "quesito": "a2) A lei não poderá estabelecer critérios de distinção entre homens e mulheres para acesso a cargos, empregos ou funções públicas, inclusive os da área de segurança pública, exceto quando a natureza do cargo assim o exigir, diante da real e efetiva necessidade.",
    "pontos": 0.2
   },
   {
    "quesito": "a3) A participação feminina na formação do efetivo das áreas de segurança pública, incluindo militares estaduais, deve ser incentivada mediante ações afirmativas.",
    "pontos": 0.2
   },
   {
    "quesito": "a4) A norma descrita no enunciado possibilita a exclusão da participação de mulheres na concorrência pelo total das vagas oferecidas nos concursos públicos para as carreiras da área de segurança pública do Estado (especificamente, no caso do enunciado, militar estadual). A norma impugnada confere espaço interpretativo que permite restrição ao acesso de candidatas do sexo feminino à totalidade das vagas ofertadas, sem qualquer justificativa real e tecnicamente demonstrada. É vedada a interpretação que legitime a imposição de qualquer limitação à participação de candidatas do sexo feminino nos certames da área de segurança pública estadual.",
    "pontos": 0.2
   },
   {
    "quesito": "a5) Dessa forma, à norma indicada no enunciado deve ser conferida interpretação conforme a Constituição, a fim de afastar qualquer exegese que admita restrição à participação de candidatas do sexo feminino, de maneira que esse dispositivo deve ser interpretado como sendo um percentual mínimo de 15%, podendo as mulheres concorrerem a todas as vagas. (Bibliografia de referência: STF. Plenário. ADI 7.480/SE, ADI 7.482/RR e ADI 7.491/CE. Rel. Min. Alexandre de Moraes, julgado em 13/05/2024 - Info 1136. STF. Plenário. ADI 7.492/AM. Rel. Min. Cristiano Zanin, julgado em 10/02/2024)",
    "pontos": 0.2
   },
   {
    "quesito": "b1) É inconstitucional, por violação aos princípios da dignidade da pessoa humana (CF, Art. 1º, III) e do valor social do trabalho (CF, Art. 1º, III e IV), a vedação a que candidato aprovado em concurso público venha a tomar posse no cargo",
    "pontos": 0.2
   },
   {
    "quesito": "b2) por não preencher os requisitos de gozo dos direitos políticos e quitação eleitoral, em razão de condenação criminal transitada em julgado (CF, Art. 15, III),",
    "pontos": 0.2
   },
   {
    "quesito": "b3) quando este for o único fundamento para sua eliminação no certame,",
    "pontos": 0.2
   },
   {
    "quesito": "b4) uma vez que é obrigatoriedade do Estado e da sociedade fornecer meios para que o egresso se reintegre à sociedade.",
    "pontos": 0.2
   },
   {
    "quesito": "b5) O início do efetivo exercício do cargo ficará condicionado ao regime da pena ou à decisão judicial do juízo de execuções, que analisará a compatibilidade de horários. (Bibliografia de referência: STF. Plenário. RE 1.282.553/RR, Rel. Min. Alexandre de Moraes, julgado em 4/10/2023 (Repercussão Geral – Tema 1190) (Info 1111)",
    "pontos": 0.2
   }
  ],
  "total": 2,
 ...
 },
 {
  ...
  "ano": 2025,
  "disciplina": "Direito Penal",
  "tema": "Execução penal: legalidade e humanidade no sistema disciplinar; isolamento e banho de sol",
  "enunciado": "Sobre o tema do sistema disciplinar no direito de execução penal, responda as perguntas a seguir de forma objetivamente fundamentada, à luz da Lei de Execução Penal, da principiologia constitucional e da jurisprudência do Supremo Tribunal Federal.\n\na) Como repercute o princípio da legalidade, levando em conta seus desdobramentos e princípios relacionados, sobre a definição das faltas disciplinares, na execução da pena privativa de liberdade?\nb) Como repercute o princípio da humanidade sobre as sanções disciplinares em geral e em especial sobre a sanção de isolamento da pessoa presa?\nc) A pessoa presa cumprindo sanção de isolamento disciplinar tem direito de sair ao pátio para banho de sol? Explique.\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "a) Princípio da legalidade no sistema disciplinar: análise qualificada do Art. 45, caput, da Lei de Execução Penal (anterioridade e taxatividade na definição das hipóteses de faltas e sanções). Há reserva legal somente para faltas graves (Art. 49, LEP).",
    "pontos": 0.75
   },
   {
    "quesito": "b1) Princípio da humanidade no sistema disciplinar: análise qualificada do Art. 45, §§1º e 2º, da Lei de Execução Penal, com vedação a sanções que coloquem em perigo a integridade física e moral do condenado e ao emprego de celas escuras, e do princípio constitucional de vedação às penas cruéis, bem como a tratamento desumano ou degradante (Art. 5º, incs. III e XLVII, e, CF).",
    "pontos": 0.5
   },
   {
    "quesito": "b2) Restrições legais à sanção de isolamento disciplinar: máximo de dez dias se isolamento preventivo, garantida a detração (Art. 60, LEP) ou de trinta dias, salvo na hipótese de Regime Disciplinar Diferenciado, e obrigação de comunicação ao juiz da execução (Art. 58, LEP).",
    "pontos": 0.25
   },
   {
    "quesito": "c) Sim, também pessoas presas em sanção de isolamento disciplinar tem direito a ao menos 2 (duas) horas diárias de pátio e \"banho de sol\", conforme base legal (Art. 40 e Art. 41, V, LEP) e decisão do Supremo Tribunal Federal em interpretação do Art. 52, IV da Lei de Execução Penal (STF, HC 172.136/SP, 2ª T., j. 10.10.2020).",
    "pontos": 0.5
   }
  ],
  "total": 2,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/tjpe-prova-discursiva.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "tema": "Direito Eleitoral: abuso do poder religioso, AIJE, litisconsórcio passivo e inelegibilidade",
  "enunciado": "No mês imediatamente anterior à realização de uma eleição municipal, foi organizada grande solenidade religiosa, no maior templo da religião X existente no município Alfa. Durante a solenidade, o sacerdote que a conduzia, perante um público de milhares de pessoas, enalteceu as características pessoais de João, que estava presente, ocupava uma posição de destaque e era candidato ao cargo eletivo de prefeito do município Alfa, e ressaltou que a sua eleição representaria um salto de qualidade para a vida de todos os munícipes. Maria, que figura como candidata a vice-prefeita de Alfa na mesma chapa de João, somente tomou conhecimento do ocorrido pela imprensa.\n\nJoana, que também figurava como candidata ao cargo eletivo de prefeita do município Alfa, ficou irresignada com o ocorrido e imediatamente ajuizou ação de investigação judicial eleitoral (AIJE) em face de João e Maria, tendo requerido a cassação do registro de candidatura, bem como a declaração da inelegibilidade de ambos para concorrerem nas eleições a serem realizadas nos oito anos subsequentes à eleição em que os fatos ocorreram. Após o trâmite regular da relação processual, os fatos foram devidamente comprovados.\n\nAnalise a situação descrita, incursionando nos seguintes aspectos:\na) o cabimento da AIJE;\nb) a legitimidade passiva; e\nc) o pedido.\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "1) A situação descrita na narrativa configura hipótese de \"abuso do poder religioso\", o qual não está previsto como ilícito autônomo na Lei Complementar nº 64/1990.",
    "pontos": 0.2
   },
   {
    "quesito": "1.1) Para que seja possível o ajuizamento da AIJE, é necessário que seja enquadrado como abuso do poder econômico, abuso do poder político ou de autoridade ou uso indevido de meios de comunicação social ou de transportes, nos termos do Art. 22, caput, da Lei Complementar nº 64/1990, o que não ocorreu no caso concreto.",
    "pontos": 0.3
   },
   {
    "quesito": "2) Como João e Maria formam uma chapa única na eleição para prefeito municipal de Alfa, ambos devem figurar no polo passivo da AIJE ajuizada por Joana, sendo hipótese de litisconsórcio passivo necessário.",
    "pontos": 0.3
   },
   {
    "quesito": "2.1) O fato de Maria desconhecer os acontecimentos não seria óbice à sua inclusão no polo passivo.",
    "pontos": 0.1
   },
   {
    "quesito": "2.2) Ainda em relação ao polo passivo, a AIJE também poderia ser ajuizada em face do sacerdote que praticou a conduta.",
    "pontos": 0.1
   },
   {
    "quesito": "2.3) É a interpretação do Art. 22, caput, e XIV, da Lei Complementar nº 64/1990.",
    "pontos": 0.1
   },
   {
    "quesito": "3) Em relação ao pedido, o requerimento de cassação da candidatura de João e Maria foi regularmente formulado, considerando que ambos, ao ver de Joana, foram beneficiados pela conduta, sendo candidatos em chapa única.",
    "pontos": 0.2
   },
   {
    "quesito": "3.1) A inelegibilidade, por sua vez, apenas deve alcançar os praticantes da conduta, o que significa dizer que somente poderia alcançar João, que efetivamente participou da solenidade, não Maria, que a desconhecia.",
    "pontos": 0.3
   },
   {
    "quesito": "3.2) O sacerdote, caso figurasse no polo passivo, também poderia ser alcançado pela inelegibilidade, caso demonstrada a prática de conduta que ensejasse a sua aplicação, isto em razão da comprovada autoria.",
    "pontos": 0.3
   },
   {
    "quesito": "3.3) É a interpretação do Art. 1º, I, d e do Art. 22, XIV, da Lei Complementar nº 64/1990.",
    "pontos": 0.1
   }
  ],
  "total": 2,
 ...
 },
 {
  ...
  "cargo": "Juiz Substituto",
  "ano": 2025,
  "fase": "2a etapa - prova discursiva (VI Concurso, Edital 01/2025; aplicada em 31/08/2025, manha)",
  "disciplina": "Direito Constitucional",
  "tema": "Norma de eficacia limitada e direito social; iniciativa legislativa e simetria; mora no poder regulamentar; prazo legal para regulamento e separacao dos poderes; metodica estruturante de Friedrich Muller",
  "enunciado": "Questão 3 - Direito Constitucional\n\nJoão ingressou com ação judicial em face do Estado Alfa, com o objetivo de que fosse implementado um direito fundamental de segunda dimensão, veiculado em norma constitucional de eficácia limitada e princípio programático, disciplinado pela Lei Estadual nº X/2024.\n\nEm sua defesa, o Estado Alfa argumentou que a Lei Estadual nº X era inconstitucional, por ter determinado a oferta do direito a partir de projeto de lei de iniciativa parlamentar, enquanto a matéria seria privativa do chefe do Poder Executivo. Acresceu, ainda, que, mesmo que esse diploma normativo não fosse inconstitucional, a implementação do direito prestacional dependeria da edição de regulamento pelo chefe do Poder Executivo, o que não pode ser assumido pelo Poder Judiciário.\n\nEm réplica, João refutou os argumentos do Estado Alfa, sustentando a constitucionalidade do processo legislativo que culminou com a edição da Lei Estadual nº X. Em relação ao regulamento, afirmou que o chefe do Poder Executivo incorrera em uma omissão ilícita, pois deixara transcorrer in albis o prazo de 60 dias fixado pelo Art. 5º da lei estadual para a sua edição, não podendo se beneficiar da própria torpeza. Também sustentou que, mesmo que seja reconhecida a inconstitucionalidade da Lei Estadual nº X, a norma constitucional que buscou disciplinar produziria efeitos em relação à legislação preexistente, devendo ser delineada na perspectiva da metódica estruturante de Friedrich Müller.\n\nAnalise, como magistrado, os argumentos apresentados por João e pelo Estado Alfa, partindo da premissa de que as informações de ordem fática são verdadeiras.\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "A ação ajuizada por João tem por base um direito social previsto em norma constitucional, que carece de integração pela legislação infraconstitucional para que possa produzir todos os seus efeitos.",
    "pontos": 0.2
   },
   {
    "quesito": "Em relação aos argumentos do Estado Alfa, a lei estadual que determinou a oferta do direito social não é de iniciativa privativa do Chefe do Poder Executivo, pois não avançou em matérias que lhe são próprias, conforme estatuído no Art. 61, §1º, da CRFB/88, aplicável ao Estado Alfa por força da simetria (CRFB/88, Art. 25, caput).",
    "pontos": 0.4
   },
   {
    "quesito": "A edição de regulamento é ato afeto ao Poder Executivo, nos termos do Art. 84, IV, da CRFB/88, aplicável ao Estado Alfa por força da simetria (CRFB/88, Art. 25, caput), mas isso não pode obstar a fruição do direito caso seja identificada uma mora irrazoável no exercício do poder regulamentar, sendo possível o exame pelo Poder Judiciário, nos termos do Art. 5º, XXXV, da CRFB/88.",
    "pontos": 0.3
   },
   {
    "quesito": "Quanto à réplica de João, observa-se que a fixação de prazo para a edição de regulamento, conforme estatuído no Art. 5º da Lei estadual nº X, afronta a separação dos poderes (CRFB/1988, Art. 2º), sendo inconstitucional.",
    "pontos": 0.3
   },
   {
    "quesito": "Apesar de a norma constitucional que dispõe sobre o direito social necessitar da legislação infraconstitucional para a integração de sua eficácia, ela apresenta uma dimensão objetiva, influindo sobre a vigência e a interpretação da legislação preexistente.",
    "pontos": 0.4
   },
   {
    "quesito": "A metódica estruturante de Friedrich Müller exige que o intérprete, sensível às peculiaridades do problema concreto, delineie o conteúdo da norma constitucional a partir da interação entre o programa da norma (texto normativo) e o âmbito da norma (realidade), o que permite a sua constante releitura.",
    "pontos": 0.4
   }
  ],
  "total": 2,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/tjto-disc.pdf"
 },
 {
  "id": "tj-to-2025-2",
  "tipo": "discursiva",
  ...
  "fase": "2a etapa - prova discursiva (VI Concurso, Edital 01/2025; aplicada em 31/08/2025, manha)",
  "disciplina": "Direito Civil",
  "tema": "Coacao como vicio do consentimento; solidariedade do terceiro que dela se aproveita (Art. 154 do CC); lucros cessantes e dano moral; juros e correcao apos a Lei 14.905/2024 (Selic menos IPCA)",
  "enunciado": "Questão 4 - Direito Civil\n\nNicanor, 83 anos de idade, recebeu uma proposta de Juca para a venda de uma casa de sua propriedade no bairro Graciosa por R$ 1.500.000,00. Ele estava animado para celebrar o negócio, pois o preço oferecido era um pouco superior ao valor de mercado que vinha sendo atribuído ao imóvel. Entretanto, Levi, seu cuidador, enxergou ali uma oportunidade para que ele e sua prima Valentina obtivessem grande lucro às custas do idoso.\n\nLevi disse a Nicanor que ele deveria desistir da proposta recebida e vender o referido imóvel para Valentina por R$ 1.000.000,00, preço inferior ao valor de mercado do imóvel. Se não fizesse isso, Levi disse a Nicanor que injetaria uma substância nos medicamentos do idoso administrados por via intravenosa, causando a sua morte. Nicanor, que mora sozinho, passou a temer por sua vida. Atormentado pelas ameaças de Levi, passou a noite em claro e agoniado, o que contribuiu para a piora de sua saúde.\n\nNo dia seguinte, Valentina esteve no domicílio de Nicanor para negociar a venda e presenciou o primo ameaçá-lo. Com medo, Nicanor efetivamente desistiu de aceitar a proposta e vendeu a casa para Valentina por R$ 1.000.000,00. O potencial comprador, Juca, quando informado, mudou-se para outra cidade e desistiu de comprar um imóvel.\n\nApós a venda, na primeira folga de Levi, Nicanor, livre do risco, enfim contou o que ocorreu para sua irmã, Iolanda, que dispensou Levi e contratou um novo cuidador, além de um segurança para a casa do irmão.\n\nResponda, de forma justificada e fundamentada:\n\na) É possível a invalidação do negócio jurídico celebrado entre Nicanor e Valentina?\n\nb) De quem pode ser exigida a indenização pelos danos sofridos e que parcelas devem compô-la?\n\nc) Como devem ser fixados os juros e a atualização monetária incidentes sobre a indenização?\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "É possível a anulação, conforme Art. 171, II, do Código Civil em virtude de coação.",
    "pontos": 0.3
   },
   {
    "quesito": "Houve fundado temor de dano iminente e considerável, tendo em vista a condição de idade e saúde de Nicanor, conforme Art. 151 e 152 do Código Civil.",
    "pontos": 0.4
   },
   {
    "quesito": "A indenização pode ser demandada de qualquer dos dois, em razão de Valentina estar ciente da ameaça, por serem solidários, conforme Art. 154 do Código Civil.",
    "pontos": 0.3
   },
   {
    "quesito": "A indenização deve abranger lucros cessantes correspondentes à diferença para o preço mais favorável que teria obtido Juca na venda do imóvel, conforme Art. 402 do Código Civil.",
    "pontos": 0.2
   },
   {
    "quesito": "A indenização deve abranger também danos morais decorrentes da violação à integridade psicofísica de Nicanor, conforme Art. 186 do Código Civil [OU] Art. 5º, V [OU] X, da Constituição Federal.",
    "pontos": 0.2
   },
   {
    "quesito": "A atualização monetária deve ocorrer pela aplicação do Índice Nacional de Preços ao Consumidor Amplo – IPCA, conforme Art. 389, parágrafo único, do Código Civil.",
    "pontos": 0.2
   },
   {
    "quesito": "Os juros devem incidir pela taxa legal: taxa referencial do Sistema Especial de Liquidação e de Custódia – Selic, deduzido o IPCA, no limite mínimo de zero, conforme o Art. 406 do Código Civil.",
    "pontos": 0.4
   }
  ],
  "total": 2,
 ...
 },
 {
  ...
  "cargo": "Juiz Substituto",
  "ano": 2025,
  "fase": "2a etapa - prova pratica de sentenca civel (VI Concurso, Edital 01/2025; aplicada em 31/08/2025, tarde)",
  "disciplina": "Direito Civil / Direito do Consumidor / Direito Processual Civil",
  "tema": "Erro medico e queda de maca: legitimidade passiva do medico, interesse de agir, responsabilidade objetiva do hospital (Art. 14 do CDC) e subjetiva do profissional liberal (Art. 14, §4o), danos materiais e morais, Sumulas 43 e 362 do STJ",
  ...
  "espelho": [
   {
    "quesito": "Afastamento da preliminar de ilegitimidade passiva do médico B. Rocha. Restou comprovado pelas provas dos autos, inclusive por meio de depoimento testemunhal, que foi o médico B. Rocha que estava presente no momento da queda pelo autor. Por se tratar de profissional vinculado à instituição hospitalar e responsável pelo atendimento direto ao paciente, aplica-se ao caso a responsabilidade solidária prevista no Art. 7º, parágrafo único, do CDC, além da jurisprudência consolidada do STJ (REsp 1.145.728/MG, Rel. Min. Luis Felipe Salomão, DJe 08.09.2011).",
    "pontos": 1
   },
   {
    "quesito": "Rejeição da preliminar de interesse de agir. O interesse de agir pressupõe necessidade e utilidade da tutela jurisdicional. A omissão dos réus no suporte pós-queda justifica a busca pela reparação judicial. O fato de o autor ter arcado com os custos do novo tratamento não descaracteriza ausência de interesse processual.",
    "pontos": 1
   },
   {
    "quesito": "Reconhecida a aplicação do Código de Defesa do Consumidor, nos termos do Art. 14 do CDC. A responsabilidade do hospital é objetiva, exigindo apenas a demonstração do dano, do fato e do nexo causal. Não se exige culpa. As excludentes do Art. 14, §3º, do CDC, não foram comprovadas pelo hospital, ao contrário, a prova testemunhal trazida pelo réu B. Rocha contribuiu com a narrativa autoral.",
    "pontos": 1.5
   },
   {
    "quesito": "Ante a prova colhida nos depoimentos das testemunhas, também ficou provada a culpa de B. Rocha, na forma do Art. 14, §4º, do CDC.",
    "pontos": 1.5
   },
   {
    "quesito": "Dano material: Comprovados mediante recibos e laudos médicos os gastos com cirurgia (R$ 15.000,00) e fisioterapia (R$ 2.000,00). Os réus devem restituir, solidariamente, os valores.",
    "pontos": 1
   },
   {
    "quesito": "Dano moral: Restou incontroverso que o autor caiu da maca após o procedimento e fraturou o fêmur. A queda de um paciente recém-operado, sem assistência adequada e sem equipamentos de segurança mínimos, causa abalo psíquico, dor e sofrimento que ultrapassam o mero aborrecimento.",
    "pontos": 1
   },
   {
    "quesito": "Dispositivo: Procedência dos pedidos para condenar os réus ao pagamento de danos materiais no valor de R$ 17.000,00, com correção monetária desde o desembolso (Súmula 43 do STJ) e juros de mora a partir da citação (Art. 405 do CC) e danos morais com correção monetária do arbitramento (Súmula 362 do STJ) e juros de mora a partir da citação (Art. 405 do CC).",
    "pontos": 2
   },
   {
    "quesito": "Dispositivo: Condenar os réus ao pagamento das custas processuais e honorários advocatícios, fixados em 10% sobre o valor da condenação, nos termos do Art. 85, §2º, do CPC. Publique-se. Registre-se. Intimem-se. Após o trânsito em julgado, arquivem-se.",
    "pontos": 1
   }
  ],
  "total": 10,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/tjto-sent-civ.pdf"
 },
 {
  "id": "tj-go-2024-1",
  "banca": "FGV",
  ...
  "ano": 2024,
  "disciplina": "Direito Civil",
  "tema": "Bem de família, novação e hipoteca; obrigação contraída em nome de filho menor",
  "enunciado": "Ricardo, despejado do imóvel onde morava, resolveu procurar um financiamento para aquisição de casa própria. Como já estava onerado por diversas dívidas, contratou-o em nome de seu filho menor, Ricardinho, devidamente assistido por ambos os genitores. Deu em hipoteca o próprio imóvel.\n\nSucede que, em decorrência de sua lamentável incúria financeira, não conseguiu honrar as primeiras parcelas. O banco, então, ajuíza execução de título extrajudicial, com pedido de excussão do bem dado em garantia. Imediatamente, o juízo procede à penhora.\n\nTemeroso de perder o bem, Ricardo procura a instituição financeira para uma renegociação do débito, o que resulta em confissão de dívida, da qual constava expressamente a novação das obrigações. Nada se dispôs acerca da garantia, que, aliás, continuou registrada no fólio real.\n\nNovamente, sobrevém o inadimplemento e, imediatamente, o devedor maneja embargos à execução, nos quais, entre outras, suscita as seguintes teses: i) nulidade da obrigação contraída em nome de seu filho menor; e ii) impenhorabilidade de seu imóvel, por constituir bem de família, sendo certo que, com a novação, não mais estariam configuradas as exceções dos Arts. 3º, II e V, da Lei nº 8.009/1990, que merecem interpretação restritiva.\n\nIndaga-se: procedem essas alegações?\n\nImportante: Não é necessário proferir sentença. Responda autonomamente a cada item.\n\nValor: 2 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "Acolhimento da tese de nulidade, com base na extrapolação do poder geral de administração dos bens dos filhos. Menção aos Arts. 1691, parágrafo único e 1.689, II, ambos do Código Civil. Interpretação teleológica dos dispositivos.",
    "pontos": 0.65
   },
   {
    "quesito": "Rejeição da tese de impenhorabilidade. Subsistência da garantia mesmo diante da novação. Menção aos Arts. 364 e 1.500 do Código Civil. Irrelevância da novação para fins de infirmar a exceção à intangibilidade do bem de famíia. Fonte obrigacional (aquisição do imóvel) compreendida na exceção do Art. 3º, II da Lei nº 8.099/1990.",
    "pontos": 1.25
   },
   {
    "quesito": "Utilização correta do idioma oficial e capacidade de exposição.",
    "pontos": 0.1
   }
  ],
  "total": 2,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/tjgo-2023-juiz-substituto-prova-escrita-discursiva.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "ano": 2024,
  "disciplina": "Direito Administrativo",
  "tema": "CPI municipal: requisitos de instauração e limites dos poderes investigatórios",
  "enunciado": "A Câmara de Vereadores de Vaca do Brejo, situada no Estado Alfa, é composta de nove vereadores. Cinco deles solicitam à Mesa Diretora da Casa Legislativa a criação de uma Comissão Parlamentar de Inquérito (CPI) para investigar suposto superfaturamento em contrato de prestação de serviços de alimentação, firmado entre o Município de Vaca do Brejo e a sociedade empresária Z Ltda., para suprir as necessidades da creche local. O pedido foi aprovado pela Casa Legislativa, tendo sido fixado um período de noventa dias para a apuração dos fatos. No transcorrer de suas atividades, a CPI: a) pede ao Plenário da Casa Legislativa que suste a execução do contrato; b) determina que o Tribunal de Contas do Estado Alfa declare a nulidade do contrato; c) convoca o prefeito Catatau para prestar esclarecimentos sobre o contrato; e d) com base em depoimentos prestados por várias testemunhas, determina a quebra do sigilo fiscal de Zé Colmeia, sócio da empresa contratada.\n\nAnalise, justificadamente, a constitucionalidade:\ni) da instauração da CPI;\nii) de cada uma das quatro medidas adotadas.\n\nValor: 1 ponto\nMáximo de 20 linhas.",
  "espelho": [
   {
    "quesito": "Estão presentes os requisitos para a criação da CPI, previstos no §3º do Art. 58 da Constituição da República: 1) requerimento de, ao menos, um terço dos parlamentares; 2) apuração de fato determinado; e 3) prazo certo.",
    "pontos": 0.15
   },
   {
    "quesito": "a) competência da Casa Legislativa para sustar a execução de contratos, nos termos do §1º do Art. 71 c/c Art. 75 da Constituição da República;",
    "pontos": 0.2
   },
   {
    "quesito": "b) autonomia dos Tribunais de Contas em relação às Casas Legislativas e falta de atribuição constitucional das Cortes de Contas para declarar a nulidade de contrato firmado por outro Poder ou órgão autônomo;",
    "pontos": 0.2
   },
   {
    "quesito": "c) a regra do §2º do Art. 58 da Constituição da República não autoriza a convocação, por CPI, do chefe do Poder Executivo, pois menciona apenas os seus auxiliares;",
    "pontos": 0.2
   },
   {
    "quesito": "d) a quebra de sigilo fiscal não é competência exclusiva das autoridades jurisdicionais, podendo ser decretada por CPI e, no caso, está devidamente fundamentada.",
    "pontos": 0.2
   },
   {
    "quesito": "Utilização correta do idioma oficial e capacidade de exposição.",
 ...
 },
 {
  ...
  "cargo": "Juiz Substituto",
  "ano": 2024,
  "fase": "2a etapa - prova escrita discursiva, Questao 7 (58o Concurso, Edital 01/2023; aplicada em 17/03/2024)",
  "disciplina": "Direito Processual Civil",
  "tema": "Inercia e omissao judicial e meios de impugnacao no CPC fora do sistema recursal (representacao, acao autonoma de honorarios, rescisoria, reclamacao, pedido de ajuste do saneador)",
  "enunciado": "Questão 7 – Discursiva – Direito Processual Civil\n\nNo exercício da atividade jurisdicional, o julgador pratica atos comissivos e omissivos. Entre os atos comissivos, destacam-se alguns pronunciamentos judiciais, como as sentenças (ou acórdãos), decisões interlocutórias e despachos. Em relação aos atos omissivos do julgador, exsurgem essencialmente duas situações: a inércia, caracterizada pelo não agir e pelo não fazer; e a omissão, consistente na não apreciação de forma adequada e completa de determinado pedido ou fundamento. Embora esse silêncio do julgador não seja desejável, o próprio Código de Processo Civil prevê situações de inércia e de omissão judicial, inclusive estabelecendo meios de impugnação específicos para combater o silêncio judicial.\n\nNesse contexto, mencione duas possíveis situações de inércia e/ou omissão judicial, indicando os respectivos meios de impugnação previstos no Código de Processo Civil, excluindo-se os recursos.\n\nValor: 1 ponto\nMáximo de 20 linhas.",
  "espelho": [
   {
    "quesito": "Primeira situação (dentre as aceitas): - Inobservância dos marcos temporais estabelecidos pelo legislador (Art. 226 do CPC). Meio de impugnação (inércia): representação (Art. 235 do CPC); - Ausência de fixação dos honorários sucumbenciais ou não indicação do valor (omissão): ação autônoma para cobrança (Art. 85, §18, do CPC); - Decisões judiciais sem fundamentação adequada ou sem distinção (Arts. 489, §1º c/c 1.022, parágrafo único, I e II, do CPC) transitadas em julgado (omissão): ação rescisória por violação à norma jurídica (Art. 966 do CPC); - Inércia em cumprir determinação do órgão julgador superior, ou quando o órgão inferior demorar excessivamente para remeter o recurso interposto para o tribunal destinatário (inércia): reclamação (Art. 988 do CPC); - Decisão de saneamento que não tenha apreciado alguma questão específica (omissão): pedido de esclarecimentos ou ajustes (Art. 357, §1º, do CPC).",
    "pontos": 0.48
   },
   {
    "quesito": "Segunda situação (dentre as mesmas hipóteses aceitas acima).",
    "pontos": 0.47
   },
   {
    "quesito": "Utilização correta do idioma oficial e capacidade de exposição.",
 ...
 },
 {
  ...
  "ano": 2024,
  "disciplina": "Direito Civil",
  "tema": "Inadimplemento das obrigações: absoluto, mora, adimplemento substancial e violação positiva do contrato",
  ...
  "espelho": [
   {
    "quesito": "1. O regime do Código Civil e a abrangência da noção de inadimplemento. A obrigação como processo.",
    "pontos": 0.5
   },
   {
    "quesito": "2. O inadimplemento e o interesse do credor. Espécies de inadimplemento: absoluto e relativo e sua extensão (inexecução total e parcial).",
    "pontos": 0.5
   },
   {
    "quesito": "3. A impossibilidade de cumprimento da obrigação ditada por fato originário ou superveniente (distinção); inadimplemento absoluto por fatos relativos ao objeto da prestação e interesse do credor; conversão da mora em inadimplemento absoluto; fato atribuível ao devedor; efeitos do artigo 389 do Código Civil.",
    "pontos": 1
   },
   {
    "quesito": "4. Inadimplemento relativo ou mora: conceito e elementos caracterizadores. Distinção entre mora, vícios redibitórios e erro. Efeitos. Espécies de mora. Constituição em mora: \"ex re\" e \"ex persona\". Purgação e cessação da mora.",
    "pontos": 1
   },
   {
    "quesito": "5. Inadimplemento mínimo do contrato ou \"adimplemento substancial\". Inadimplemento antecipado.",
    "pontos": 0.5
   },
   {
    "quesito": "6. O inadimplemento dos deveres laterais: a violação positiva do contrato. Caracterização e efeitos.",
    "pontos": 0.5
   }
  ],
  "total": 4,
  "fonte": "https://www.tjsp.jus.br/Segmento/Magistrados/Noticia?codigoNoticia=106090&pagina=1",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "ano": 2024,
  "disciplina": "Direito Administrativo",
  "tema": "Princípios da Lei 14.133/21: formalismo mitigado, publicidade e transparência, segregação de funções e desenvolvimento nacional sustentável",
  ...
  "espelho": [
   {
    "quesito": "1. Como compatibilizar o princípio do formalismo mitigado em certames licitatórios, com o princípio constitucional da legalidade estrita? (ponderação com eficiência, proposta mais vantajosa, probidade e interesse público primário; arts. 12, III, e 147 da Lei 14.133/2021; arts. 20, 21 e 30 da LINDB)",
    "pontos": 0.5
   },
   {
    "quesito": "2. Em que consistem os princípios da publicidade e da transparência? Como distingui-los e como se conjugam na Lei 14.133/21? (critérios teleológico e de abrangência; Portal Nacional de Contratações Públicas, art. 174)",
    "pontos": 0.5
   },
   {
    "quesito": "3. Em que consistem os princípios da segregação de funções e do desenvolvimento nacional sustentável? Esclareça se e como a interpretação sistemática do ordenamento jurídico ajuda, ou não, na compreensão de cada um (arts. 7º a 10 e 169, § 3º, II, da Lei 14.133/2021; art. 22 da LINDB; raiz constitucional e tratados internacionais)",
    "pontos": 0.5
   }
  ],
  "total": 1.5,
 ...
 },
 {
  ...
  "tema": "Tutela da integridade da vítima em crimes sexuais: Lei 14.245/2021 (Lei Mariana Ferrer) e vedação à revitimização",
  ...
  "espelho": [
   {
    "quesito": "QUESITO 1: A universalização dos direitos humanos das mulheres e a evolução do Direito no que pertine ao tema (CEDAW, Convenção de Belém do Pará, CF/88, Lei Maria da Penha, Lei 14.245/2021 e Protocolo do CNJ para Julgamento com Perspectiva de Gênero)",
    "pontos": 0.4
   },
   {
    "quesito": "QUESITO 2: A Lei nº 14.245/2021 (arts. 400-A e 474-A do CPP e art. 81, § 1º-A, da Lei 9.099/95; destinatários do dever e âmbito de incidência)",
    "pontos": 0.2
   },
   {
    "quesito": "QUESITO 3: É legítima a prática de questionar o comportamento e os modos de vida da mulher vítima durante a investigação e o julgamento de processos envolvendo crimes sexuais e de violência contra a mulher?",
    "pontos": 0.5
   },
   {
    "quesito": "QUESITO 4: O direito à prova e a pretensão de juntada de Boletins de Ocorrência e certidões criminais da vítima",
    "pontos": 0.4
   }
  ],
  "total": 1.5,
 ...
 {
  "id": "trf-2-2024-1",
  "banca": "TRF2 (Comissão Organizadora e Examinadora do concurso — banca própria)",
  "orgao": "TRF-2",
  "cargo": "Juiz Federal Substituto",
  "ano": 2024,
  "disciplina": "Direito Processual Civil / Direito Constitucional",
  "tema": "Ação popular: adequação da via eleita, duplo grau invertido do art. 19 da Lei 4.717/65 e assistência litisconsorcial de pessoa jurídica",
  "enunciado": "2 - Margarida move ação popular contra o Município XXX, na qual imputa ao réu ofensa ao meio ambiente. A petição inicial anexa documentos (estudos técnicos ambientais) e sustenta que a Administração é negligente no trato ambiental. Pede, ao final, a condenação do réu ao replantio e à adoção de medidas compensatórias pela degradação e falta de manutenção de 18 parques municipais, ocorridas na gestão do atual prefeito. A contestação do Município não combate o mérito, e apenas aponta que a Autora usa a ação como vingança, já que foi exonerada de cargo de confiança que exercia na municipalidade. O Ministério Público oficiou pelo julgamento imediato. Pergunta-se: (a) considerando o estado dos autos, é correto proferir sentença? Se positivo, em que sentido? (b) independentemente da análise anterior, caso a pretensão seja julgada procedente contra o Município, com integral acatamento do pedido, o feito deve ser submetido ao duplo grau? (c) abstraia as perguntas anteriores e considere que, após a contestação, autarquia federal (IBAMA) peticiona e requer ingresso como assistente litisconsorcial da autora. O juiz estadual, em virtude dessa petição, remete o feito à Justiça Federal. Como deve decidir o juiz federal? (1,0 ponto)",
  "espelho": [
   {
    "quesito": "(a) Deve ser proferida sentença de extinção. A via eleita é impertinente. A ação popular visa a anular ou a declarar a nulidade de ato administrativo lesivo a bens indicados (art. 5º, LXXIII, da Lei Maior e art. 1º da Lei 4.717/65). Não se trata de alternativa à ação civil pública, com drible na regra de legitimidade ativa. A ação popular não se destina a meramente impor obrigação de fazer, menos ainda sem que apontado ato concreto a ser declarado nulo. Menção legal obrigatória: art. 5º, LXXIII, da CF ou art. 1º da Lei 4.717/65. Critério: recebe ponto pleno quem indica a extinção do feito por inadequação da via eleita OU a ilegitimidade ativa do cidadão para mover ação civil pública. Nota zero para quem julga procedente, procedente em parte, ou improcedente sem notar a ação civil pública travestida.",
    "pontos": 0.4
   },
   {
    "quesito": "(b) O artigo 19 da Lei 4.717/65 é regra especial e a doutrina amplamente majoritária assinala que se trata de duplo grau invertido, e essa norma afasta a incidência do artigo 496 do CPC. Assim, se o pedido for julgado procedente não há o duplo grau. Leva zero o candidato que aplicou o artigo 496 sem analisar o artigo 19 da Lei 4.717/65.",
    "pontos": 0.2
   },
   {
    "quesito": "(c) A ação popular admite apenas a assistência litisconsorcial formulada por outro cidadão, e não por pessoa jurídica (art. 6º, § 5º, da Lei 4.717/65). O IBAMA, se o quiser, em tese é legitimado para promover ação civil pública, mas na impertinente ação popular nem há posição jurídica do IBAMA a ser negativamente afetada. O juiz federal deve indeferir o ingresso da autarquia e devolver os autos ao juiz estadual, conforme artigo 45, § 3º, do CPC. Menção obrigatória: art. 6º, § 5º, da Lei 4.717/65 e art. 45, § 3º, do CPC. Quem respondeu corretamente sem dispositivos legais leva 0,3; quem afastou a assistência sem citar a determinação de retorno, 0,25; quem deferiria o ingresso, zero.",
    "pontos": 0.4
   }
  ],
  "total": 1,
  "fonte": "https://static.trf2.jus.br/nas-internet/documento/consultas/concursos/magistrados/24/prova-discursiva.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
 ...
 },
 {
  ...
  "ano": 2024,
  "disciplina": "Direito Tributário",
  "tema": "Imunidade recíproca e sucessão tributária da União em bens da extinta RFFSA (Tema 224 STF); IPTU x taxa; certidão positiva com efeito de negativa (Tema 273 STJ)",
  "enunciado": "9 - Certos imóveis da extinta sociedade de economia mista Rede Ferroviária Federal S/A (RFFSA) foram incorporados ao patrimônio da União Federal. Contudo, sobre alguns desses bens, situados no Município Alfa, havia débitos tributários de IPTU e de Taxa de Coleta Domiciliar de Lixo (TCDL) anteriores à transferência dos imóveis para a União.\n\nO Município Alfa ajuíza execução fiscal contra a União para cobrar tais débitos pretéritos, indicando a condição de responsável tributária por sucessão da União. A União apresenta embargos à execução, alegando sua imunidade tributária que a desobrigaria de pagar tais débitos, mas sem garantir o juízo.\n\nÀ luz da legislação aplicável e jurisprudência dos Tribunais Superiores, responda:\n(A) É legítimo ao Município Alfa realizar tais cobranças contra a União quanto ao: (i) IPTU e (ii) à TCDL? Justifique separadamente.\n(B) Caso a União requeira ao Município Alfa certidão de débitos tributários, na pendência dessa execução fiscal, qual tipo de certidão deverá ser emitida? (1,0 ponto)\n17 linhas",
  "espelho": [
   {
    "quesito": "Item (A)(i) — IPTU: o candidato deve dizer que a imunidade tributária recíproca não exonera o sucessor das obrigações tributárias relativas aos fatos jurídicos tributários ocorridos antes da sucessão. A matéria é o Tema 224 do STF. Como a RFFSA não era imune, à época da constituição do fato gerador o IPTU era por ela devido.",
    "pontos": 0.3
   },
   {
    "quesito": "Item (A)(ii) — TCDL: o candidato deve dizer que, por se tratar de taxa, a exação não é abarcada pela imunidade de impostos, podendo ser cobrada — cf. art. 150, VI, caput, da CF/1988.",
    "pontos": 0.3
   },
   {
    "quesito": "Item (B) — Certidão: 0,1 apenas por dizer o nome correto da certidão a ser emitida — certidão positiva com efeito de negativa; mais 0,1 pela citação da base legal, o art. 206 do CTN; e 0,2 pela explicação da razão da expedição, cf. Tema Repetitivo 273 do STJ: “A Fazenda Pública, quer em ação anulatória, quer em execução embargada, faz jus à expedição da certidão positiva de débito com efeitos negativos, independentemente de penhora, posto inexpropriáveis os seus bens”. Aceitou-se também, como variante, quem afirmou que a Fazenda Pública paga seus débitos judiciais pelo regime de precatórios, bem como o argumento da presunção de solvabilidade dos entes públicos.",
    "pontos": 0.4
   }
  ],
  "total": 1,
 ...
 },
 {
  ...
  "tema": "Zetética, dogmática jurídica e jusnaturalismo; a jurisprudência no Brasil contemporâneo",
  "enunciado": "Questão 1 – Formação Humanística\na) Apresente, sucintamente, os conceitos e as características da zetética, da dogmática jurídica e do jusnaturalismo.\nb) Analise os contornos da jurisprudência no Brasil contemporâneo, no contexto dos conceitos indicados no item anterior.",
  "espelho": [],
  "total": null,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/juiz-de-direito-substituto-provadiscursiva.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 ...
 },
 {
  ...
  "cargo": "Juiz Substituto",
  "ano": 2023,
  "disciplina": "Direito e Formação Humanística",
  "tema": "Uso de redes sociais por magistrados: Resolução CNJ nº 305",
  "enunciado": "Carlos e Teresa são membros da magistratura estadual. O primeiro é vitaliciado e a segunda é vitalicianda.\n\nNo seu perfil de uma rede social, Carlos postou uma mensagem na qual dizia que mulheres eram emocionalmente desequilibradas e, por isso, apenas confiava em homens para exercer a chefia da serventia das varas em que atuava.\n\nNa mesma semana, Teresa fez uma postagem divulgando um artigo acadêmico que havia escrito tratando da questão do \"marco temporal das terras indígenas\" (pendente de julgamento no STF).\n\nConsiderando a Resolução do CNJ que estabelece os parâmetros para o uso das redes sociais pelos membros do Poder Judiciário, as postagens feitas por Carlos e Teresa são aceitáveis ou não? Justifique.\n\nValor: 1 ponto\nMáximo de 20 linhas.",
  "espelho": [
   {
    "quesito": "O fato de Carlos ser vitaliciado e Teresa vitalicianda não faz diferença quanto à aplicação da Resolução CNJ nº 305, isto é, ela se aplica igualmente a ambos.",
    "pontos": 0.2
   },
   {
    "quesito": "A publicação de Carlos se caracteriza como misoginia, o que é vedado pelo inciso III do artigo 4º da Resolução CNJ nº 305. Por isso não é aceitável.",
    "pontos": 0.4
   },
   {
    "quesito": "A postagem de Teresa, embora seja de um tema pendente de julgamento, é aceitável, pois o artigo caracteriza atividade típica do exercício do magistério, o que está ressalvado no inciso I do artigo 4º da Resolução CNJ nº 305.",
    "pontos": 0.4
   }
  ],
  "total": 1,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/juiz-substitutoj-subs-tipo-1.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "ano": 2023,
  "disciplina": "Direito Penal",
  "tema": "Teoria do domínio do fato: autoria, coautoria, participação, autoria mediata e domínio de aparato organizado de poder",
  "enunciado": "O que é a teoria do domínio do fato? Como ela distingue autoria, coautoria e participação? O que é autoria mediata? O que é autoria por domínio de aparato organizado de poder? A teoria do domínio do fato foi adotada pela legislação penal? Se não, é com ela compatível? É aplicável aos crimes culposos e omissivos? Justifique.\n\nValor: 2,5 pontos\nMáximo de 30 linhas.",
  "espelho": [
   {
    "quesito": "A teoria do domínio do fato, desenvolvida sobretudo por autores alemães (Welzel, Roxin etc.), é uma teoria eclética que combina elementos objetivos e subjetivos, formais e materiais, e considera o autor a figura central do fato típico. É autor quem, nos crimes comissivos e dolosos, realiza a ação típica, pessoalmente, ou valendo-se de terceiro como instrumento. No primeiro caso, há autoria direta ou de mão própria (domínio da ação); no segundo, autoria indireta ou mediata (domínio da vontade).",
    "pontos": null
   },
   {
    "quesito": "Na autoria mediata há um domínio da vontade do executor sobre o autor mediato, que incide em erro ou sofre coação física ou moral etc. (v.g., o médico usa a enfermeira para matar o paciente, sem que ela o saiba). Nesse caso, somente o autor mediato é punível. Haveria coautoria (domínio funcional) se ambos agissem dolosamente.",
    "pontos": null
   },
   {
    "quesito": "O coautor é um autor; a coautoria é uma forma de autoria. Aqui há domínio funcional do fato, que se realiza por meio da divisão de tarefas entre os coautores durante a execução do crime. Somente é coautor quem participa da execução do delito.",
    "pontos": null
   },
   {
    "quesito": "A participação, que se expressa por meio de instigação, induzimento ou cumplicidade (auxílio moral ou material), é acessória relativamente à autoria. O partícipe não é um autor, logo não é um coautor, razão pela qual não intervém nos atos de execução. Não há domínio do fato por parte do partícipe. Apesar disso, o partícipe pode ser apenado mais duramente do que o autor ou coautor, segundo as circunstâncias do caso.",
    "pontos": null
   },
   {
    "quesito": "Em geral, especialmente Claus Roxin, entende-se que a teoria do domínio do fato não é aplicável aos crimes culposos e omissivos, mas somente aos crimes comuns, comissivos e dolosos. É que naqueles não há domínio do fato, mas infração de dever.",
    "pontos": null
   },
   {
    "quesito": "O Código Penal adotou não a teoria do domínio do fato, mas a teoria monista/unitária (CP, art. 29), que trabalha com um conceito extensivo de autor e não faz distinção entre autoria, coautoria e participação, pois considera que todos que tomam parte num crime são autores desse crime. Apesar disso, a teoria do domínio do fato, que trabalha com um conceito restritivo de autor, é perfeitamente compatível com o CP, já tendo sido admitida pelo STF e STJ inclusive.",
    "pontos": null
   },
   {
    "quesito": "A autoria mediata por domínio de aparato organizado de poder é um conceito criado por Roxin. Trata-se de nova modalidade de autoria mediata, cuja particularidade reside no fato de que, ao contrário do conceito tradicional, autor mediato e imediato são igualmente culpáveis e puníveis. Aqui o autor mediato se vale de um aparato de poder para o cometimento de crimes, sendo que os executores são fungíveis ou substituíveis (v.g., execuções ordenadas por uma estrutura mafiosa).",
    "pontos": null
   }
  ],
  "total": 2.5,
  "fonte": "https://conhecimento.fgv.br/sites/default/files/concursos/trf1-2023-juiz-substituto-prova-escrita-discursiva.pdf",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura federal"
 ...
 },
 {
  ...
  "ano": 2019,
  "disciplina": "Direito Penal",
  "tema": "Concurso de pessoas: teorias sobre o conceito de autor e a distinção entre autor e partícipe; teoria adotada pelo Código Penal",
  "enunciado": "DISSERTAÇÃO 2\n\nDiscorra sobre as teorias de imputação pessoal de fatos criminosos (conceito de autor), cotejando-as inclusive quanto à distinção entre autor e partícipe. Em seu texto, identifique a(s) teoria(s) adotada(s) pelo Código Penal, justificando a sua resposta.",
  "espelho": [
   {
    "quesito": "Teoria Extensiva Unitária (Monista, Monística, Negativa): autor é quem de qualquer modo contribui para o cometimento do crime; todas as ações/contribuições são equivalentes; não há distinção entre autor e partícipe; funda-se na teoria da equivalência das condições. [critério: cada resposta que discorra sobre as teorias Extensiva Unitária, Restritiva Objetivo-Formal, Restritiva Objetivo-Material e Subjetiva, ainda que eventualmente de forma combinada, será pontuada em até 0,25 cada; total 1,00]",
    "pontos": 0.25
   },
   {
    "quesito": "Teoria Restritiva Objetivo-Formal (Positiva, Afirmativa): autor é apenas quem realiza a ação típica (verbo nuclear do tipo legal); é partícipe quem concorre para o crime, mas não pratica a conduta nuclear do tipo.",
    "pontos": 0.25
   },
   {
    "quesito": "Teoria Restritiva Objetivo-Material: distingue autor de partícipe conforme a relevância da sua contribuição para o delito (maior perigosidade da atuação do autor, causalidade determinante ou coadjuvante).",
    "pontos": 0.25
   },
   {
    "quesito": "Teoria Subjetiva: distingue autor do partícipe pelo critério da vontade — autor age com animus auctoris (fato próprio); partícipe age com animus socii, colaborando em fato alheio.",
    "pontos": 0.25
   },
   {
    "quesito": "Teoria do Domínio do Fato (Objetiva-Subjetiva, Objetiva-Final): autor é a figura central do acontecer típico — domínio da ação (autor direto), domínio da vontade de terceiro (autor mediato) e domínio funcional do fato (coautor); partícipe realiza tarefa acessória sem controle sobre a continuidade ou paralisação. [por exigir mais detalhamento, será pontuada com até 0,6]",
    "pontos": 0.6
   },
   {
    "quesito": "Apontar qual (ou quais) teoria é adotada pelo Código Penal, justificando — demonstrando ciência da divergência doutrinária (Teoria Unitária do CP/40 x distinção reconhecida pela Reforma de 1984, item 25 da Exposição de Motivos; posições de Nucci, Zaffaroni e Pierangeli, Juarez Cirino dos Santos, Luiz Flávio Gomes e Luiz Regis Prado) e fundamentando razoavelmente seu posicionamento à luz do art. 29 e parágrafos do CP.",
    "pontos": 0.4
   }
  ],
  "total": 2,
 ...
 },
 {
  ...
  "ano": 2019,
  "disciplina": "Direito Administrativo",
  "tema": "Improbidade administrativa: responsabilidade pessoal do agente público, tomada de contas e ressarcimento, e segurança jurídica na mudança de orientação (LINDB)",
  ...
  "espelho": [
   {
    "quesito": "Item 1 — A responsabilidade dos agentes públicos pela prática de atos de improbidade é pessoal e subjetiva, exigindo-se o dolo nas condutas dispostas nos arts. 9°, 10-A e 11 da LIA, e ao menos a culpa naquelas estatuídas no art. 10.",
    "pontos": 0.2
   },
   {
    "quesito": "Item 1 — Conforme previsto no art. 28 da LINDB, os agentes públicos também respondem pessoalmente por suas decisões ou opiniões técnicas, em caso de dolo ou erro grosseiro.",
    "pontos": 0.2
   },
   {
    "quesito": "Item 2 — Esses processos, instaurados por órgão de controle externo (arts. 70, par. único e 71, inc. II, da CF), visam a apuração de irregularidades/ilegalidades praticadas por agentes públicos que resultem prejuízo ao erário.",
    "pontos": 0.1
   },
   {
    "quesito": "Item 2 — Constatado e quantificado o efetivo dano, cabe a determinação de ressarcimento das verbas públicas, não a título punitivo, mas sim reparatório/compensatório, como ocorre na cominação de ressarcimento integral do dano por ato de improbidade administrativa.",
    "pontos": 0.1
   },
   {
    "quesito": "Item 3 — Não pode, ante o princípio da segurança jurídica.",
    "pontos": 0.2
   },
   {
    "quesito": "Item 3 — Não pode, ante o expressamente disposto no art. 24 da LINDB. (OBS: receberá nota parcial a indicação na resposta de outro princípio e/ou dispositivo pertinente, como o art. 2º, par. único, inc. XIII, da Lei 9.784/99.)",
    "pontos": 0.2
   }
  ],
  "total": 1,
 ...
 },
 {
  ...
  "tema": "Fato do produto x vício do produto: prescrição e decadência, solidariedade do comerciante, dano moral e lucros cessantes",
  ...
  "espelho": [
   {
    "quesito": "A hipótese é de defeito do produto, fato do produto, ou acidente de consumo (art. 13, CDC). Os cereais eram inadequados ao consumo, mas no caso Aline sofreu danos patrimoniais e moral; o que diferencia o defeito do vício é exatamente o dano: no defeito há descumprimento do dever de segurança e um dano patrimonial ou extrapatrimonial, enquanto no vício a impropriedade torna o produto inadequado ou impróprio ao uso, apenas.",
    "pontos": 0.1
   },
   {
    "quesito": "Verificado o fato do produto, incidem as normas que tratam da prescrição, não as da decadência. Prescrição corresponde ao defeito do produto; decadência ao vício.",
    "pontos": 0.2
   },
   {
    "quesito": "Não há a princípio solidariedade entre fabricante e fornecedor-direto/comerciante no fato do produto; este somente responderá, solidariamente também, quando, dentre outras hipóteses, o defeito decorrer da má-conservação do produto.",
    "pontos": 0.1
   },
   {
    "quesito": "Quanto ao vício, há responsabilidade solidária (art. 18 do CDC).",
    "pontos": 0.2
   },
   {
    "quesito": "Houve dano moral em razão das repercussões negativas, a despeito da não ingestão do produto, e também dano patrimonial, pelo afastamento do serviço (há decisões em um e em outro sentido no STJ; o candidato poderá defender uma ou outra).",
    "pontos": 0.2
   },
   {
    "quesito": "A teoria da causalidade adequada justifica a responsabilidade por lucros cessantes; como não está presente a hipótese do art. 13 do CDC, apenas o fabricante responde pelos lucros cessantes e pela compensação do dano moral.",
    "pontos": 0.2
   }
  ],
  "total": 1,
 ...
 },
 {
  ...
  "tema": "Registro de candidatura, inelegibilidade infraconstitucional superveniente (art. 1º, I, 'l', da LC 64/90), RCED e AIRC",
  ...
  "espelho": [
   {
    "quesito": "Fase do processo eleitoral em que partidos e coligações requerem à Justiça Eleitoral o registro de candidatos aos cargos eletivos; preenchimento de requisitos de registrabilidade, condições de elegibilidade e não possuir causas de inelegibilidade, objetivamente aferíveis quando da formalização do pedido de registro; § 10 do art. 11 da Lei Federal 9.504/97.",
    "pontos": 0.3
   },
   {
    "quesito": "Hipótese de inelegibilidade infraconstitucional nos termos do art. 1º, inciso I, letra 'l' da Lei Complementar Federal 64/90; se a condenação for posterior ao registro de candidatura, até a data do pleito eleitoral, trata-se de inelegibilidade infraconstitucional superveniente, passível de recurso de expedição de diploma conforme art. 262, CE; não será cabível o RCED contra inelegibilidade infraconstitucional preexistente ao registro da candidatura, conforme jurisprudência do TSE (precedente).",
    "pontos": 0.4
   },
   {
    "quesito": "Sim; se ocorrer antes do registro da candidatura, pode ser objeto de impugnação ao registro de candidatura; conforme art. 3º da LC 64/90.",
    "pontos": 0.3
   }
  ],
  "total": 1,
 ...
 },
 {
  ...
  "ano": 2018,
  "disciplina": "Direito Constitucional",
  "tema": "Independência judicial e imparcialidade; funções do CNJ, controle interno e controle de constitucionalidade; revisão judicial dos atos do CNJ",
  ...
  "espelho": [
   {
    "quesito": "Quesito 2.1 — 0: Não expôs adequadamente nenhum dos conceitos cobrados no item. 1: Expôs adequadamente o conceito de independência judicial, mas não apresentou o de imparcialidade nem relacionou ambos OU expôs adequadamente o conceito de imparcialidade judicial, mas não apresentou o de independência nem relacionou ambos. 2: Expôs adequadamente ambos os conceitos, mas não trouxe justificadamente OU apresentou equivocadamente a relação entre eles. 3: Expôs adequadamente ambos os conceitos e trouxe de forma justificada e correta a relação entre eles.",
    "pontos": 0.8
   },
   {
    "quesito": "Quesito 2.2 — 0: Não apresentou ou o fez equivocadamente as funções do CNJ nem tratou adequadamente da competência do órgão para o controle de constitucionalidade. 1: Apresentou sucintamente as funções do CNJ, mas não destacou seu caráter de controle interno nem tratou adequadamente da competência do órgão para o controle de constitucionalidade OU destacou o caráter de controle interno do CNJ, mas não descreveu as suas funções, nem tratou adequadamente da competência do órgão para o controle de constitucionalidade. 2: Apresentou sucintamente as funções do CNJ e destacou seu caráter de controle interno, mas não tratou adequadamente da competência do órgão para o controle de constitucionalidade. 3: Apresentou sucintamente as funções do CNJ, destacou seu caráter de controle interno e abordou adequadamente, com base na jurisprudência do STF, a competência do órgão para o controle de constitucionalidade.",
    "pontos": 0.8
   },
   {
    "quesito": "Quesito 2.3 — 0: Não expôs corretamente sobre a possibilidade de revisão judicial dos atos do CNJ nem indicou (ou indicou equivocadamente) os juízos competentes para tal atribuição. 1: Expôs corretamente sobre a possibilidade de revisão judicial dos atos do CNJ, mas não indicou (ou indicou equivocadamente) os juízos competentes. 2: Expôs corretamente sobre a possibilidade de revisão judicial dos atos do CNJ e indicou — apenas parcialmente — os juízos competentes. 3: Expôs corretamente sobre a possibilidade de revisão judicial dos atos do CNJ e indicou adequadamente, com base na jurisprudência do STF, os juízos competentes para tal atribuição.",
    "pontos": 0.8
   }
  ],
  "total": 2.5,
  "fonte": "https://cdn.cebraspe.org.br/concursos/TJ_CE_18_JUIZ/arquivos/390_TJCE_DISC001_01.PDF",
  "tipo": "discursiva",
  "peca": "",
  "fase": "",
  "carreira": "Magistratura estadual"
 },
 {
  ...
  "tema": "Extravio de bagagem em voo internacional: antinomia aparente, Convenções de Varsóvia e Montreal x CDC (Tema 210 do STF) e termo inicial da correção monetária do dano moral",
  "enunciado": "QUESTÃO 4\n\nMaria viajou de Fortaleza – CE para Lisboa – PT e, quando chegou ao seu destino, foi informada de que sua bagagem havia sido extraviada. Por essa razão, quando retornou ao Brasil, ajuizou uma ação de reparação por danos morais e materiais com base na legislação brasileira. A companhia aérea, em contestação, pugnou pela limitação da indenização com base nas convenções de Varsóvia e Montreal. Após a tramitação regular da ação, o processo foi concluso para prolação de sentença.\n\nAcerca da situação hipotética apresentada, responda, de forma justificada, aos seguintes questionamentos.\n\n1 Nessa situação, à luz do STF, há antinomia aparente ou real de normas? [valor: 0,45 ponto]\n\n2 Em conformidade com o entendimento do STF, que solução deverá ser dada ao caso? [valor: 0,45 ponto]\n\n3 Existe limitação para a indenização dos danos materiais e morais no sentido em que argumentou a defesa? [valor: 0,90 ponto]\n\n4 Na hipótese de acolhimento do pedido de indenização por danos morais, qual será o termo inicial para a fixação de sua correção monetária? [valor: 0,60 ponto]",
  "espelho": [
   {
    "quesito": "Quesito 2.1 — 0: Respondeu que se trata de antinomia real de normas. 1: Respondeu que se trata de uma antinomia aparente de normas, mas não indicou os princípios aplicáveis. 2: Respondeu que se trata de antinomia aparente de normas, com a incidência dos princípios da especialidade e cronologia.",
    "pontos": 0.45
   },
   {
    "quesito": "Quesito 2.2 — 0: Não mencionou que o STF concluiu pela prevalência da Convenção de Varsóvia e do Pacto de Montreal. 1: Mencionou que o STF concluiu pela prevalência da Convenção de Varsóvia e do Pacto de Montreal, mas não fundamentou sua resposta. 2: Mencionou que o STF concluiu pela prevalência da Convenção de Varsóvia e Pacto de Montreal, fundamentando a resposta também com base na regra do art. 178 da CF.",
    "pontos": 0.45
   },
   {
    "quesito": "Quesito 2.3 — 0: Afirmou que não existe limite para o arbitramento dos danos materiais e morais. 1: Afirmou que existe limite para essas reparações, sem fazer a distinção entre os danos morais e materiais. 2: Afirmou que há limite para a indenização dos danos materiais (Convenção de Varsóvia e Pacto de Montreal), mas que, segundo o próprio STF, não existe limitação para a reparação por danos morais (incidindo o CDC nesse caso).",
    "pontos": 0.9
   },
   {
    "quesito": "Quesito 2.4 — 0: Respondeu que o termo inicial seria o da citação, ocorrência do evento danoso ou qualquer outro que não o da fixação em sentença. 1: Respondeu que o termo inicial deve ser contado a partir da sentença (data do arbitramento dos danos morais), mas não indicou o posicionamento jurisprudencial sumulado do STJ. 2: Respondeu que o termo inicial deve ser contado a partir da sentença (data do arbitramento dos danos morais), indicando que existe entendimento sumulado do STJ nesse sentido (Súmula n.º 362/STJ).",
    "pontos": 0.6
   }
  ],
  "total": 2.5,
 ...
 },
 {
  ...
  "ano": 2018,
  "disciplina": "Direito Civil",
  "tema": "Divórcio: guarda, regulamentação de visitas, alimentos, partilha no regime de comunhão parcial (sub-rogação de bem particular, verba salarial) e nome",
 ...
 },
 {
  ...
  "cargo": "Juiz de Direito Substituto",
  "ano": 2018,
  "fase": "2ª fase — Prova Escrita Discursiva, Edital 01/2018, 4 horas, 5 questões, máximo 25 linhas",
  "disciplina": "Formação Humanística / Filosofia do Direito",
  "tema": "Ética e Política nas sociedades modernas — universalidade hipotética e seus efeitos no Direito",
  "enunciado": "Questão 01\nDiscorra em, no máximo, 25 (vinte e cinco) linhas, acerca da relação entre Ética e Política nas sociedades modernas, conhecida por universalidade hipotética, explorando os seus efeitos no Direito.",
  "espelho": [],
  "total": null,
  "fonte": "https://www.tjmg.jus.br/data/files/F2/65/E5/5D/E488761014735876B04E08A8/PROVA%20ESCRITA%20DISCURSIVA%20_1_.pdf"
 },
 {
  ...
  "fase": "2ª fase — Prova Escrita Discursiva, Edital 01/2018, 4 horas, 5 questões, máximo 25 linhas",
  "disciplina": "Formação Humanística / Filosofia do Direito",
  "tema": "Habermas: equiprimordialidade (cooriginalidade) e a relação entre Moral e Direito",
