...
for (const f of ['support.js', 'icon.svg', 'auth.js', 'icon-180.png', 'legis-web.html', 'juris-web.html', 'juris-mapas-sv.html', 'juris-index.js', 'juris-text.js', 'contas-index.js', 'contas-text.js', 'modelos-edital.js', 'discursivas.js', 'oral.js', 'treino.js', 'area-web.html', 'processo-web.html', 'ritos.js', 'pecas.js', 'incidencia.js', 'area-modulos.js']) {
