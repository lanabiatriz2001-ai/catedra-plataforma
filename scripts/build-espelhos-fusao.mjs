// RENOMEADO em 21/08/2026: a outra sessão reutilizou o nome build-espelhos.mjs para o
// gerador do Simulado de 2ª fase. ESTE aqui é o script de FUSÃO (espelhos-magistratura.json
// → discursivas). Os dois convivem.
