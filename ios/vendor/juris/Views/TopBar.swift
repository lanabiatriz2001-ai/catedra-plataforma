...
struct TopBar: View {
    ...
    var body: some View {
        HStack(spacing: 14) {
            ...
            buscaGlobal
            temaControl
            // SettingsLink abre a janela de Ajustes do app — conceito só do macOS (no
            // iPadOS não há cena de Settings). O botão sai daqui em vez de virar um
            // controle morto: os ajustes do Cátedra vivem na aba do Cátedra.
        }
